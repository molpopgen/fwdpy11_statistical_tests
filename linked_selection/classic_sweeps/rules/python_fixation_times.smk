rule python_fixation_times:
    ...
    log: "output/python_fixation_times.log"
    threads: 64
    params:
    ...
    shell:
        """
        python3 testcode/fixation_times_from_binomial_simulation.py --popsize {params.popsize} --nreps {params.nreps} --ncores {threads} > output/python_fixation_times.log
        """
